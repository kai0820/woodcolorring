...
# copy resource `FILES` and `FOLDERS` to TARGET_FILE_DIR
function(cocos_copy_target_res cocos_target)
    ...
    foreach(cc_file ${opt_FILES})
        ...
        add_custom_command(TARGET ${cocos_target} POST_BUILD
            COMMAND ${CMAKE_COMMAND} -E echo "copy file into : ${file_name} ..."
    ...
    foreach(cc_folder ${opt_FOLDERS})
        ...
        foreach(res_file ${folder_files})
            ...
            add_custom_command(TARGET ${cocos_target} POST_BUILD
                COMMAND ${CMAKE_COMMAND} -E echo "copy file into : ${res_file_relat_path} ..."
