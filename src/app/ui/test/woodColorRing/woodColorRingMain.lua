...
function WoodColorRingMain:initBG()
	...
	boardTop:setPosition(cc.p(GConst.win_size.width*0.5, GConst.win_size.height*0.5 + 100))
	...
	boardBottom:setPosition(cc.p(GConst.win_size.width*0.5, GConst.win_size.height*0.5 - 200))
